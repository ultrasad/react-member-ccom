            ...
            <header role="banner">
                <div className="container wrapper clearfix">
                    <Link to="/members" onClick={this.props.clearState} className="title" title="CCOM Member manager">
                        ...
                        <h1><i className="icon-member"></i>Members manager</h1>
                    </Link>
                    {
                        this.state.searchBox === true ?
                            <div className="search" id="search">
                                {/*
                                    <input ref='userName' placeholder="Search..." onChange={this.onSearchChange} value={this.props.searchInput} name="search" onKeyPress={this.props.onSearchMember} type="search" />
                                */}
